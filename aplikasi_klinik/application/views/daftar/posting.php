	...
	foreach($posting as $key){
		$data .= '<tr>
					...
					<td>
						...
						<a href="'.base_url().'index.php/popup_kartupasien/kartu_pasien/'.$key->kode_pasien.'">Lihat Preview</a> 
...
<!-- <a href="'.base_url().'index.php/daftar_cetak/baca/'.$key->kode_pasien.'">Lihat</a>  -->
