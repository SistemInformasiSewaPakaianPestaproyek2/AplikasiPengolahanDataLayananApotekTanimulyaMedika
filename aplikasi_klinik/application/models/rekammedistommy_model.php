...
class Rekammedistommy_model extends CI_Model {
    ...
    public function buat_tabel($data)
    {
        ...
        // heading tabel
        $this->table->set_heading('No','Tanggal', 'Kode Rekam Medis', 'Kode Pasien', 'Anamnesa', 'Alergi','Terapi','Nama Dokter','Aksi');
    ...
    public function tambah()
    {
        $rekammedis = array(
			...
			'kode_dokter' => $this->input->post('140002')
        );
