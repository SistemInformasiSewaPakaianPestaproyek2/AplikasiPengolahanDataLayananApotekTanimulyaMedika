...
class Rekammedistommy extends CI_Controller
{
    public $data = array(
                        'modul'         => 'rekammedis',
                        ...
                        'pagination'    => '',
                        'tabel_data'    => '',
                        'main_view'     => 'rekammedis/rekammedis2',
                        'form_action'   => '',
                        'form_value'    => '',
                        'option_datapasien'  => '',
						'option_datadokter'  => '',
    ...
    public function index($offset = 0)
	{
        ...
        // cari data siswa
        $rekammedis = $this->rekammedis->cari_tommy($offset);

        // ada data siswa, tampilkan
        if ($rekammedis)
        {
            $tabel = $this->rekammedis->buat_tabel1($rekammedis);
        ...
        $this->load->view('template_tommy', $this->data);
	}
    ...
    public function tambah()
    {
        ...
        $this->data['form_action'] = 'rekammedistommy/tambah';
        ...
        if($kode_dokter)
        {
            ...
            {
                $this->data['option_datadokter'][$row->kode_dokter ='140002'] = $row->nama_dokter = 'dr. Tommy R';
            }
        }
        // data kelas tidak ada
        else
    ...
    public function edit($kode_rekam = NULL)
    {
        ...
        $this->data['main_view']   = 'rekammedis/rekammedis_form';
        $this->data['form_action'] = 'rekammedistommy/edit/' . $kode_rekam;
