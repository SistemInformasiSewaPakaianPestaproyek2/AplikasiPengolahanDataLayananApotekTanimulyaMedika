...
class Rekammedismariana extends CI_Controller
{
    public $data = array(
                        'modul'         => 'rekammedis',
                        ...
                        'pagination'    => '',
                        'tabel_data'    => '',
                        'main_view'     => 'rekammedis/rekammedis9',
                        'form_action'   => '',
                        'form_value'    => '',
                        'option_datapasien'  => '',
						'option_datadokter'  => '',
    ...
    public function index($offset = 0)
	{
        ...
        // cari data siswa
        $rekammedis = $this->rekammedis->cari_mariana($offset);

        // ada data siswa, tampilkan
        if ($rekammedis)
        {
            $tabel = $this->rekammedis->buat_tabel8($rekammedis);
        ...
        $this->load->view('template_mariana', $this->data);
	}
    ...
    public function tambah()
    {
        ...
        $this->data['form_action'] = 'rekammedismariana/tambah';
        ...
        if($kode_dokter)
        {
            ...
            {
                $this->data['option_datadokter'][$row->kode_dokter ='140011'] = $row->nama_dokter = 'dr.Mariana S';
            }
        }
        // data kelas tidak ada
        else
    ...
    public function edit($kode_rekam = NULL)
    {
        ...
        $this->data['main_view']   = 'rekammedis/rekammedis_form';
        $this->data['form_action'] = 'rekammedismariana/edit/' . $kode_rekam;
