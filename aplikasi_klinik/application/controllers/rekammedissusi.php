...
class Rekammedissusi extends CI_Controller
{
    public $data = array(
                        'modul'         => 'rekammedis',
                        ...
                        'pagination'    => '',
                        'tabel_data'    => '',
                        'main_view'     => 'rekammedis/rekammedis5',
                        'form_action'   => '',
                        'form_value'    => '',
                        'option_datapasien'  => '',
						'option_datadokter'  => '',
    ...
    public function index($offset = 0)
	{
        ...
        // cari data siswa
        $rekammedis = $this->rekammedis->cari_susi($offset);

        // ada data siswa, tampilkan
        if ($rekammedis)
        {
            $tabel = $this->rekammedis->buat_tabel4($rekammedis);
        ...
        $this->load->view('template_susi', $this->data);
	}
    ...
    public function tambah()
    {
        ...
        $this->data['form_action'] = 'rekammedissusi/tambah';
        ...
        if($kode_dokter)
        {
            ...
            {
                $this->data['option_datadokter'][$row->kode_dokter ='140005'] = $row->nama_dokter = 'dr.Susi';
            }
        }
        // data kelas tidak ada
        else
    ...
    public function edit($kode_rekam = NULL)
    {
        ...
        $this->data['main_view']   = 'rekammedis/rekammedis_form';
        $this->data['form_action'] = 'rekammedissusi/edit/' . $kode_rekam;
